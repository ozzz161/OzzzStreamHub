...
В текущем релизе появились выделение комментариев, замена слов и скрытие ссылок для OBS, выбор GIF, звука и видов алертов, а также более подробный статус подключения YouTube. Подробности и установщик — на [странице релиза v1.3.0](https://github.com/ozzz161/OzzzStreamHub/releases/tag/v1.3.0).
