...
| | |
| --- | --- |
| **Общий чат** | Сообщения YouTube, VK Видео Live, Twitch и RUTUBE в одном окне; обычный и узкий режимы, отдельные статусы площадок и настройки внешнего вида. |
...
| **OBS** | Два браузерных источника чата с независимым оформлением и историей, отдельный источник алертов. Адреса копируются из программы. Есть готовые темы, шрифты, цвета и анимации. |
...
Снимки сделаны с демонстрационными сообщениями без подключения к аккаунтам.
...
В текущем релизе добавлена кнопка Twitch-клипа в узком чате, уточнены статусы YouTube и улучшено восстановление чата после временных сбоев. Подробности и установщик — на [странице релиза v1.2.2](https://github.com/ozzz161/OzzzStreamHub/releases/tag/v1.2.2).
